...
IL_003d:
	{
		...
		float L_9 = __this->___m_LastOkTime_6;
		float L_10 = __this->___m_WaitTime_4;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CarUserControl_FixedUpdate_m982486D66D154041EB653DF93A5E6E1B82D676EA (CarUserControl_t7B8F74D1E7DD6B1F9CEC83D603513B87318761E1* __this, const RuntimeMethod* method) 
{
	...
	float V_0 = 0.0f;
	{
		...
		// m_Car.Move(h, 1, 1, 0f);
		CarController_tCEF3C1742808D025CBF959BD90A024FE2BD47347* L_2 = __this->___m_Car_4;
		float L_3 = V_0;
		NullCheck(L_2);
		CarController_Move_m58147A90BA06725693F3D769D075DC1252DA7C28(L_2, L_3, (1.0f), (1.0f), (0.0f), NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AeroplaneUserControl4Axis_FixedUpdate_m35E30B0EB6ABCC8B4BFBEE493D670502A5A216B8 (AeroplaneUserControl4Axis_t9396946D00BED33572513BF866043A5704B78F54* __this, const RuntimeMethod* method) 
{
	...
	float V_1 = 0.0f;
	{
		...
		AeroplaneController_tF7B2D1F5B7C8EC6AE50BD3C053F1167ADB1658DF* L_6 = __this->___m_Aeroplane_6;
		float L_7 = V_0;
		float L_8 = V_1;
...
IL_00a9:
	{
		...
		ThirdPersonCharacter_t38A1E2C23379165892F56A60648F43774604DC8F* L_25 = __this->___m_Character_4;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_26 = __this->___m_Move_7;
		bool L_27 = V_2;
		bool L_28 = __this->___m_Jump_8;
		NullCheck(L_25);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void FirstPersonController_GetInput_mA973EBB03719A5E34DCE7DD7B438705438F1A45B (FirstPersonController_tC0EDB51A962C99D85A43D28A7CC6C2A2B06548A7* __this, float* ___0_speed, const RuntimeMethod* method) 
{
	...
	FirstPersonController_tC0EDB51A962C99D85A43D28A7CC6C2A2B06548A7* G_B11_1 = NULL;
	{
		...
		bool L_4 = __this->___m_IsWalking_4;
		G_B1_0 = L_3;
		if (L_4)
		{
			G_B2_0 = L_3;
	...
	{
		float L_5 = __this->___m_RunSpeed_6;
		G_B3_0 = L_5;
		G_B3_1 = G_B1_0;
		goto IL_0034;
	}
...
IL_002e:
	{
		float L_6 = __this->___m_WalkSpeed_5;
		G_B3_0 = L_6;
		G_B3_1 = G_B2_0;
	}
...
IL_0034:
	{
		*((float*)G_B3_1) = (float)G_B3_0;
		...
		__this->___m_Input_24 = L_9;
		// if (m_Input.sqrMagnitude > 1)
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_10 = (&__this->___m_Input_24);
		float L_11;
	...
	{
		// m_Input.Normalize();
		Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7* L_12 = (&__this->___m_Input_24);
...
IL_005f:
	...
	{
		bool L_15 = __this->___m_UseFovKick_12;
		if (!L_15)
		{
			goto IL_00b7;
		}
	...
	}
	{
		...
		bool L_19 = __this->___m_IsWalking_4;
		G_B9_0 = __this;
		if (!L_19)
		{
			G_B10_0 = __this;
	...
	{
		FOVKick_t3C3EA3A67FCDBC913162032B60ABB3B4505A6D0D* L_20 = __this->___m_FovKick_13;
		NullCheck(L_20);
		RuntimeObject* L_21;
...
IL_00a6:
	{
		FOVKick_t3C3EA3A67FCDBC913162032B60ABB3B4505A6D0D* L_22 = __this->___m_FovKick_13;
		NullCheck(L_22);
		RuntimeObject* L_23;
